...
class Range extends Component {
  ...
  addDataview() {
    ...
    this.dataViewMin = new carto.dataview.Formula(this.props.layer.source, this.props.column, {
      operation: carto.operation.MIN
    });

    this.dataViewMax = new carto.dataview.Formula(this.props.layer.source, this.props.column, {
 ...
 createFilter() {
   ...
   this.props.layer.source.addFilter(filter);
